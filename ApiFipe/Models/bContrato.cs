...
namespace ApiFipe.Models
{
    public class bContrato
    {
        ...
        public bool EnviaEmailGestorContratos(int idProposta, int idContrato, string url)
        {
            try
            {
                #region Envia E-mail para o(s) Gestor(es) de Contratos informando encaminhamento de Contrato
                var email = new bEmail(db).GetEmailById(27);
        ...
        *  Salva informacao se o Contrato é Abono ou não
        ...
        //{
        //    var itens = db.PropostaComentario.Where(w => w.IdProposta == id).ToList();
        //    return itens;
        //}
