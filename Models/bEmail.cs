...
namespace ApiFipe.Models
{
    public class bEmail
    {
        ...
        //EGS 30.04.2021 Traz o email configurado pelo TITULO
        public EmailConfigurado GetEmailByTitulo(string pDsTitulo)
        {
            var emailConfigurado = db.EmailConfigurado.Where(w => w.DsTitulo == pDsTitulo).FirstOrDefault();
        ...
        public void EnviarEmail(string EmailDestinatario, string NomeDestinatario, string Assunto, string Corpo, byte[] Anexo, string NomeAnexo)
        {
            ...
            //===========================================================================================================================
            //===========================================================================================================================
            if (!FIPEContratosContext.EnvironmentIsProduction) EmailDestinatario = sEmailErroDestiny2;
